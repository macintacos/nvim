...
---@field children changetree.Row[]

---Text of a line of `path` in the working tree, used to caption orphan hunks.
---@alias changetree.LineText fun(path: string, lnum: integer): string?

---@class changetree.Node
---@field sym MiniPickers.Symbol
---@field children changetree.Node[]
...
---@param nodes changetree.Node[]
---@param first integer
---@param last integer
---@param out changetree.Node[]
---@return changetree.Node[]
...
---@param hunk changetree.Hunk
---@param group changetree.Row
---@param line_text changetree.LineText?
---@return changetree.Row
...
---@param files changetree.File[] Hunks ascending by line, as `git diff` emits them.
---@param symbols_by_path table<string, MiniPickers.Symbol[]> Flat `symbols.flatten` output by file path.
---@param line_text changetree.LineText? Captions orphan hunks; without it they are named by line range alone.
---@return changetree.Row[]
...
---@param row changetree.Row File or symbol row.
---@param depth integer
---@param is_open (fun(id: string): boolean)?
---@return changetree.Row
...
---@param rows changetree.Row[] File rows from `build`; left unmodified.
