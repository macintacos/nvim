...
---@field children prtree.Row[]

---Text of a line of `path` in the working tree, used to caption orphan hunks.
---@alias prtree.LineText fun(path: string, lnum: integer): string?

---@class prtree.Node
---@field sym MiniPickers.Symbol
---@field children prtree.Node[]
...
---@param nodes prtree.Node[]
---@param first integer
---@param last integer
---@param out prtree.Node[]
---@return prtree.Node[]
...
---@param hunk prtree.Hunk
---@param group prtree.Row
---@param line_text prtree.LineText?
---@return prtree.Row
...
---@param files prtree.File[] Hunks ascending by line, as `git diff` emits them.
---@param symbols_by_path table<string, MiniPickers.Symbol[]> Flat `symbols.flatten` output by file path.
---@param line_text prtree.LineText? Captions orphan hunks; without it they are named by line range alone.
---@return prtree.Row[]
...
---@param row prtree.Row File or symbol row.
---@param depth integer
---@param is_open (fun(id: string): boolean)?
---@return prtree.Row
...
---@param rows prtree.Row[] File rows from `build`; left unmodified.
