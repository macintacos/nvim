...
function M.set_keymaps(opts)
  ...
  -- FIXME: This doesn't actually change anything - need to reach out in LazyVim discussions
  -- Delete keymaps we want to overwrite, and set the top-level names immediately
  del("n", "<leader>h")
  opts.defaults["<leader>h"] = nil
  opts.defaults["<leader>h"] = { name = "+help" }
  ...
  return opts -- Make sure options are passed back
end
