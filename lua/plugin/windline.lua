...
local gcolors = require("plugin.global_colors")
...
windline.setup({
    colors_name = function(colors)
        ...
        colors.magenta_a = gcolors.pink
        colors.magenta_b = mod(gcolors.pink, 0.5)
        colors.magenta_c = mod(gcolors.pink, 0.7)

        colors.yellow_a = gcolors.yellow
        colors.yellow_b = mod(gcolors.yellow, 0.5)
        colors.yellow_c = mod(gcolors.yellow, 0.7)

        colors.blue_a = gcolors.cyan
        colors.blue_b = mod(gcolors.cyan, 0.5)
        colors.blue_c = mod(gcolors.cyan, 0.7)

        colors.green_a = gcolors.green
        colors.green_b = mod(gcolors.green, 0.5)
        colors.green_c = mod(gcolors.green, 0.7)

        colors.red_a = gcolors.red
        colors.red_b = mod(gcolors.red, 0.5)
        colors.red_c = mod(gcolors.red, 0.7)

        -- Other colors
        colors.black = gcolors.background_darker
        colors.red = gcolors.red
        colors.green = gcolors.green
        colors.yellow = gcolors.yellow
        colors.blue = gcolors.cyan
        colors.magenta = gcolors.pink
        colors.cyan = gcolors.cyan
        colors.white = gcolors.foreground

        colors.black_light = gcolors.background_darker -- terminal_color_8,
        colors.NormalFg = gcolors.foreground -- hightlight Normal fg
        colors.NormalBg = gcolors.background -- hightlight Normal bg
        colors.ActiveFg = gcolors.foreground -- hightlight StatusLine fg
        colors.ActiveBg = gcolors.background_light -- hightlight StatusLine bg
        colors.InactiveFg = gcolors.foreground -- hightlight StatusLineNc fg
        colors.InactiveBg = gcolors.background -- hightlight StatusLineNc bg
