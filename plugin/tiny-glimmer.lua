-- github.com/rachartier/tiny-glimmer.nvim
-- Animated highlights for yank, paste, search, undo, and redo
vim.pack.add({ "https://github.com/rachartier/tiny-glimmer.nvim" }, { load = false })
